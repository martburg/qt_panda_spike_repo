...
def _build_blocked_payload(state: Any) -> tuple[list[str], list[dict[str, object]]]:
    blocked_by: list[str] = []
...
def _decode_estop_state(*, router: Any, snap: Any, axis_id: str) -> tuple[dict[str, object], str]:
    estop_word = int(
...
def _resolve_axis_owner(*, state: Any, axis_id: str) -> str:
...
def _build_axis_snapshot_entry(
    *,
    ...
    state: Any,
    router: Any,
    cmd_axes: dict[str, Any],
    axis_cmd: dict[str, Any],
