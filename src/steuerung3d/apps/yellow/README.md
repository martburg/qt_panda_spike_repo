...
The app loads its UI from `assets/yellow3_merged.ui` via `ui_shell.py`.
...
## Files
- `tools/yellow_ui_split/yellow3_shell_marker.ui`
...
- `tools/yellow_ui_split/parts/pageGuider.ui`
- `tools/yellow_ui_split/parts/pageParameters.ui`
- `tools/yellow_ui_split/parts/pageDiagnostics.ui`
  - The extracted contents of the corresponding pages.

- `tools/yellow_ui_split/merge_yellow3_ui.py`
  - Rebuilds `assets/yellow3_merged.ui` by inserting each part into the correct page.
...
```bash
python tools/yellow_ui_split/merge_yellow3_ui.py --shell tools/yellow_ui_split/yellow3_shell_marker.ui --parts tools/yellow_ui_split/parts --out src/steuerung3d/apps/yellow/assets/yellow3_merged.ui
```

3) Runtime uses `assets/yellow3_merged.ui`; edit parts and merge to refresh it.
...
## Diagnostics split
`tools/yellow_ui_split/parts/pageDiagnostics.ui` is now a *shell* that contains the `tabsDiagnostics` structure, but each large child page is split into its own file under `tools/yellow_ui_split/parts/diagnostics/`:
