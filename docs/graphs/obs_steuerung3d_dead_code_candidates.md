# OBSOLETE — snapshot from an earlier refactor

This report was generated against an older module graph and now contains many stale module/function names.
If you need an up-to-date dead-code report, regenerate it from the current repo state.
